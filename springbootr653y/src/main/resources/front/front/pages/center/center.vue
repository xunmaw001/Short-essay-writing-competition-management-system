	...
	<view class="content">
		<view :style='{"minHeight":"100vh","padding":"0px 0 120rpx","borderColor":"#21d5ae","flexWrap":"wrap","background":"#fff","borderWidth":"0px 0 0","display":"block","width":"100%","position":"relative","borderStyle":"dashed","height":"auto"}'>
			<view :style='{"padding":"40rpx 40rpx 40rpx","boxShadow":"inset 0px 0px 0px 0px #f7dcab","margin":"0px auto 20rpx","borderColor":"#e9be70","display":"flex","justifyContent":"space-between","borderRadius":"0","flexWrap":"wrap","background":"none","borderWidth":"0px 0px 0px 0px","width":"calc(100% - 0px)","position":"relative","borderStyle":"solid","height":"auto"}' @tap="onPageTap('../user-info/user-info')" class="header" v-bind:class="{'status':isH5Plus}">
				<view :style='{"padding":"0","margin":"0","alignItems":"flex-start","flexWrap":"wrap","background":"none","display":"flex","width":"calc(100% - 0px)","position":"static","height":"auto","order":"2"}' v-if="tableName=='fuzeren'" class="userinfo">
					<view :style='{"padding":"36rpx 16rpx 60rpx 40rpx","margin":"0 auto","borderColor":"#86ce9f #e1f9eb","flexDirection":"column","display":"block","float":"left","justifyContent":"center","minHeight":"324rpx","borderRadius":"20rpx","background":"url(http://codegen.caihongy.cn/20230410/9f502c94c8b84bc0aea8e0b413fa7698.png) repeat-x 0% 100%,#f5fdf8","borderWidth":"8rpx 2rpx 0","width":"100%","borderStyle":"solid","height":"auto"}' class="info">
						<view :style='{"padding":"4rpx 8rpx","borderColor":"#eecece","margin":"0 0 0px","color":"#369555","borderWidth":"0 0 0px","width":"90%","lineHeight":"60rpx","fontSize":"28rpx","borderStyle":"dashed","fontWeight":"600"}'>{{user.fuzerenzhanghao}}<text v-if="user.vip&& user.vip=='是'">(VIP)</text></view>
					</view>
				</view>
				<view :style='{"padding":"0","margin":"0","alignItems":"flex-start","flexWrap":"wrap","background":"none","display":"flex","width":"calc(100% - 0px)","position":"static","height":"auto","order":"2"}' v-if="tableName=='youke'" class="userinfo">
					...
					<view :style='{"padding":"36rpx 16rpx 60rpx 40rpx","margin":"0 auto","borderColor":"#86ce9f #e1f9eb","flexDirection":"column","display":"block","float":"left","justifyContent":"center","minHeight":"324rpx","borderRadius":"20rpx","background":"url(http://codegen.caihongy.cn/20230410/9f502c94c8b84bc0aea8e0b413fa7698.png) repeat-x 0% 100%,#f5fdf8","borderWidth":"8rpx 2rpx 0","width":"100%","borderStyle":"solid","height":"auto"}' class="info">
						<view :style='{"padding":"4rpx 8rpx","borderColor":"#eecece","margin":"0 0 0px","color":"#369555","borderWidth":"0 0 0px","width":"90%","lineHeight":"60rpx","fontSize":"28rpx","borderStyle":"dashed","fontWeight":"600"}'>{{user.youkezhanghao}}<text v-if="user.vip&& user.vip=='是'">(VIP)</text></view>
					</view>
				</view>
				<view :style='{"padding":"0","margin":"0","alignItems":"flex-start","flexWrap":"wrap","background":"none","display":"flex","width":"calc(100% - 0px)","position":"static","height":"auto","order":"2"}' v-if="tableName=='xuesheng'" class="userinfo">
					<image :style='{"padding":"0px","margin":"0px 0 20rpx","borderColor":"#1bd0a9","objectFit":"cover","textAlign":"center","right":"100rpx","borderRadius":"100%","top":"80rpx","background":"rgba(255,255,255,.6)","borderWidth":"0px","width":"120rpx","position":"absolute","borderStyle":"solid","height":"120rpx","zIndex":"999"}' :src="user.touxiang?baseUrl+user.touxiang:'/static/gen/upload.png'"></image>
					<view :style='{"padding":"36rpx 16rpx 60rpx 40rpx","margin":"0 auto","borderColor":"#86ce9f #e1f9eb","flexDirection":"column","display":"block","float":"left","justifyContent":"center","minHeight":"324rpx","borderRadius":"20rpx","background":"url(http://codegen.caihongy.cn/20230410/9f502c94c8b84bc0aea8e0b413fa7698.png) repeat-x 0% 100%,#f5fdf8","borderWidth":"8rpx 2rpx 0","width":"100%","borderStyle":"solid","height":"auto"}' class="info">
						<view :style='{"padding":"4rpx 8rpx","borderColor":"#eecece","margin":"0 0 0px","color":"#369555","borderWidth":"0 0 0px","width":"90%","lineHeight":"60rpx","fontSize":"28rpx","borderStyle":"dashed","fontWeight":"600"}'>{{user.xueshengxuehao}}<text v-if="user.vip&& user.vip=='是'">(VIP)</text></view>
					</view>
				</view>
				<view :style='{"padding":"0","margin":"0","alignItems":"flex-start","flexWrap":"wrap","background":"none","display":"flex","width":"calc(100% - 0px)","position":"static","height":"auto","order":"2"}' v-if="tableName=='pingwei'" class="userinfo">
					<view :style='{"padding":"36rpx 16rpx 60rpx 40rpx","margin":"0 auto","borderColor":"#86ce9f #e1f9eb","flexDirection":"column","display":"block","float":"left","justifyContent":"center","minHeight":"324rpx","borderRadius":"20rpx","background":"url(http://codegen.caihongy.cn/20230410/9f502c94c8b84bc0aea8e0b413fa7698.png) repeat-x 0% 100%,#f5fdf8","borderWidth":"8rpx 2rpx 0","width":"100%","borderStyle":"solid","height":"auto"}' class="info">
						<view :style='{"padding":"4rpx 8rpx","borderColor":"#eecece","margin":"0 0 0px","color":"#369555","borderWidth":"0 0 0px","width":"90%","lineHeight":"60rpx","fontSize":"28rpx","borderStyle":"dashed","fontWeight":"600"}'>{{user.pingweizhanghao}}<text v-if="user.vip&& user.vip=='是'">(VIP)</text></view>
					</view>
				</view>
