...
<script>
	export default {
		...
		methods: {
			// 支付
			onPayTap(){
				uni.setStorageSync('paytable','jingsaileibie');
			...
			onAcrossTap(tableName,crossOptAudit,statusColumnName,tips,statusColumnValue){
				uni.setStorageSync('crossTable','jingsaileibie');
			...
			async init(){
				...
				let res = await this.$api.info('jingsaileibie', this.id);
			...
			// 添加评论
			async onCommentTap() {
				this.$utils.jump(`../discussjingsaileibie/add-or-update?refid=${this.id}`)
			},
			onSHTap() {
