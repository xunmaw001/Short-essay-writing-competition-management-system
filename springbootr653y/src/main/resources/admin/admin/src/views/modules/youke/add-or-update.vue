<template>
	<div class="addEdit-block" :style='{"padding":"30px 50px"}' style="width: 100%;">
		...
		>
			<template >
				<el-form-item :style='{"width":"100%","margin":"0 0 20px 0","display":"inline-block"}' class="input" v-if="type!='info'"  label="游客账号" prop="youkezhanghao">
					<el-input v-model="ruleForm.youkezhanghao" placeholder="游客账号" clearable  :readonly="ro.youkezhanghao"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 20px 0","display":"inline-block"}' v-else class="input" label="游客账号" prop="youkezhanghao">
					<el-input v-model="ruleForm.youkezhanghao" placeholder="游客账号" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 20px 0","display":"inline-block"}' class="input" v-if="type!='info'"  label="游客姓名" prop="youkexingming">
					<el-input v-model="ruleForm.youkexingming" placeholder="游客姓名" clearable  :readonly="ro.youkexingming"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 20px 0","display":"inline-block"}' v-else class="input" label="游客姓名" prop="youkexingming">
					<el-input v-model="ruleForm.youkexingming" placeholder="游客姓名" readonly></el-input>
				</el-form-item>
