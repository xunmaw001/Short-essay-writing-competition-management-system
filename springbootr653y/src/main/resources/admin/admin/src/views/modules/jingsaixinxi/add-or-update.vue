	...
	<div class="addEdit-block" :style='{"padding":"30px 50px"}' style="width: 100%;">
		...
		>
			<template >
				...
				<el-form-item :style='{"width":"100%","margin":"0 0 20px 0","display":"inline-block"}' class="input" v-else-if="ruleForm.jingsaibianhao" label="竞赛编号" prop="jingsaibianhao">
					<el-input v-model="ruleForm.jingsaibianhao" placeholder="竞赛编号" readonly></el-input>
				</el-form-item>
				...
				<el-form-item :style='{"width":"100%","margin":"0 0 20px 0","display":"inline-block"}' class="select" v-if="type!='info'"  label="竞赛类别" prop="jingsaileibie">
				...
				<el-form-item :style='{"width":"100%","margin":"0 0 20px 0","display":"inline-block"}' class="date" v-if="type!='info'" label="报名开始时间" prop="baomingkaishishijian">
					<el-date-picker
						value-format="yyyy-MM-dd HH:mm:ss"
						v-model="ruleForm.baomingkaishishijian" 
						type="datetime"
						:readonly="ro.baomingkaishishijian"
						placeholder="报名开始时间"
					></el-date-picker>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 20px 0","display":"inline-block"}' class="input" v-else-if="ruleForm.baomingkaishishijian" label="报名开始时间" prop="baomingkaishishijian">
					<el-input v-model="ruleForm.baomingkaishishijian" placeholder="报名开始时间" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 20px 0","display":"inline-block"}' class="date" v-if="type!='info'" label="报名截止时间" prop="baomingjiezhishijian">
					<el-date-picker
						value-format="yyyy-MM-dd HH:mm:ss"
						v-model="ruleForm.baomingjiezhishijian" 
						type="datetime"
						:readonly="ro.baomingjiezhishijian"
						placeholder="报名截止时间"
					></el-date-picker>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 20px 0","display":"inline-block"}' class="input" v-else-if="ruleForm.baomingjiezhishijian" label="报名截止时间" prop="baomingjiezhishijian">
					<el-input v-model="ruleForm.baomingjiezhishijian" placeholder="报名截止时间" readonly></el-input>
				</el-form-item>
				...
				<el-form-item :style='{"width":"100%","margin":"0 0 20px 0","display":"inline-block"}' class="select" v-if="type!='info'" label="负责人账号" prop="fuzerenzhanghao">
				...
				<el-form-item :style='{"width":"100%","margin":"0 0 20px 0","display":"inline-block"}' class="input" v-else-if="ruleForm.fuzerenzhanghao" label="负责人账号" prop="fuzerenzhanghao">
				...
				<el-form-item :style='{"width":"100%","margin":"0 0 20px 0","display":"inline-block"}' class="textarea" v-if="type!='info'" label="报名条件" prop="baomingtiaojian">
					<el-input
				...
				<el-form-item :style='{"width":"100%","margin":"0 0 20px 0","display":"inline-block"}' v-else-if="ruleForm.baomingtiaojian" label="报名条件" prop="baomingtiaojian">
					<span :style='{"fontSize":"14px","lineHeight":"40px","color":"#333","fontWeight":"500","display":"inline-block"}'>{{ruleForm.baomingtiaojian}}</span>
				</el-form-item>
